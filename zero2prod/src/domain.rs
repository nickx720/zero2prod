...
impl SubscriberName {
    /// Returns an instance of `SubscriberName` if the input satisfies all our validation constraints on subscriber names. Panics otherwise
